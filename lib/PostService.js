...
var PostService = exports.PostService = function () {
	function PostService(fetch, loadIdToken) {
	...
	_createClass(PostService, [{
		...
		value: function post(fetch, url, body) {
			...
			return new Promise(function (resolve, reject) {
				_this.loadIdToken().then(function (_ref) {
					var jwt = _ref.jwt,
...
function PostServiceFactory(_ref2) {
	...
	var postService = new PostService(fetch, loadIdToken);
